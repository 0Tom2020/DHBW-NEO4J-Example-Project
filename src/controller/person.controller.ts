...
personControllerRouter.put('/new', (req, res, next) => {
...
personControllerRouter.put('/connection', (req, res, next) => {
...
//PUT delete connection between two persons
personControllerRouter.put('/deleteConnection', (req, res, next) => {
...
//PUT delete Person
personControllerRouter.put('/delete', (req, res, next) => {
    const session = getSession();
    if (req.body['name'] === undefined) {
        res.status(400).send('Bad Request');
        return;
